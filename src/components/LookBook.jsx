    ...
    return (
        <div className="lookbook-container">
            ...
            <div className="lookbook-text">
                <h1>Special designs, large color selection</h1>
                <div className="lookbook-underline"></div>
                <p>
                    Come to our salon and experience a relaxing pedicure and nail
                    treatment with special designs or a wide selection of colors.
                </p>
